...
The package focuses on practical texture workflows:
  - Encode/decode BC1/DXT1, BC2/DXT3, BC3/DXT5,
    BC4/BC5 (UNORM and SNORM), BC6H/BPTC-HDR, BC7/BPTC
...
Uncompressed DDS and KTX support RGBA, BGRA, R8/RG8 (UNORM and SNORM), and RGB10A2;
